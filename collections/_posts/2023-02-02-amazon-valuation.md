...
<div class="w3-container w3-center" style="padding:20px 0px 20px">
    <p>表1　サム・オブ・ザ・パーツによるAmazonの企業価値評価</p>
    <img title="Amazon's valuation" class="w3-image" width="500" max-width="500"
        src="../assets/image/blog/amazon/valuation.png" alt="Amazon's valuation">
</div>
